...
<html lang="es" class="developers">
    <head>
		...
		<meta name="description" content="Portal para Desarrolladores - Universidad de los Ni&ntilde;os">
...
?>
        ...
        <div id="breadcrumb"><a href="./">Desarrolladores</a></div>
...
?>
        ...
        <div id="content">
        	...
        	<p>En este portal se encuentra toda la informaci&oacute;n necesaria para ser un desarrollador y hacer parte del proyecto de la Universidad de los Ni&ntilde;os.</p>
        	<p>Acá podrá encontrar la información técnica más relevante tanto del software como del hardware y colaborar con este proyecto de código abierto.</p>
        </div>
